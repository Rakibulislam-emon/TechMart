...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        const password = form.password.value;signInWithGoogle

        try {
            // You can handle the login logic here (e.g., API call to authenticate the user)
                ...
                <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                    <div>
                        <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-800 leading-tight">
                            Welcome Back to TechMart Electronics
                        </h2>
                        <p className="text-sm mt-6 text-gray-600">
                            Log in to access the latest electronics, gadgets, and exclusive deals. Your account at TechMart Electronics gives you personalized recommendations and a streamlined shopping experience.
                        </p>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                ...
                                <div className="text-sm">
                                    <a  className="text-blue-600 hover:text-blue-500 font-semibold">
