...
export default function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        // Handle form submission here, e.g., call your registration function
        const user = {
            username,
            email,
            password,
                ...
                <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                    <div>
                        <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-800 leading-tight">
                            Join TechMart Electronics Today!
                        </h2>
                        <p className="text-sm mt-6 text-gray-600">
                            Create an account to explore the latest electronics, gadgets, and exclusive offers. Enjoy a personalized shopping experience tailored just for you.
                        </p>
                    ...
                    <form
                        ...
                        <div className="space-y-4">
                            <div>
                                <input name="firstName" type="text" required className="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="First Name" />
                            </div>
                            <div>
                                <input name="lastName" type="text" required className="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Last Name" />
                            </div>
                            <div>
                            ...
                            <div>
                                <input name="password" type="password" autoComplete="new-password" required className="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Password" />
                            </div>
                            <div>
                                <input name="confirmPassword" type="password" autoComplete="new-password" required className="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Confirm Password" />
                            </div>
                        </div>
